...
public class PhoneActivityTwo extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_phone_two);
        tvSongDes = (TextView) findViewById(R.id.tvSongDes2);
        ...
        mediaPlayer=MediaPlayer.create(this,R.raw.fenibut2);
