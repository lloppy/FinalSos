...
public class PhoneActivitySeven extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_phone_seven);
        tvSongDes = (TextView) findViewById(R.id.tvSongDes7);
        ...
        mediaPlayer=MediaPlayer.create(this,R.raw.fenibut7);
