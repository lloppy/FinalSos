...
public class PhoneActivitySix extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_phone_six);
        tvSongDes = (TextView) findViewById(R.id.tvSongDes6);
        ...
        mediaPlayer=MediaPlayer.create(this,R.raw.fenibut6);
