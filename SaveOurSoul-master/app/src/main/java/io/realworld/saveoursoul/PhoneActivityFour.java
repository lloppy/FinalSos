...
public class PhoneActivityFour extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_phone_four);
        tvSongDes = (TextView) findViewById(R.id.tvSongDes4);
        ...
        mediaPlayer=MediaPlayer.create(this,R.raw.fenibut4);
