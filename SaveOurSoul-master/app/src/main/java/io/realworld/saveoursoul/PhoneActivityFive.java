...
public class PhoneActivityFive extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_phone_five);
        tvSongDes = (TextView) findViewById(R.id.tvSongDes5);
        ...
        mediaPlayer=MediaPlayer.create(this,R.raw.fenibut5);
